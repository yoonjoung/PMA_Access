...
global surveylist " 
	...
	NGLagosR2 NGLagosR3 NGLagosR4 NGLagosR5 NGLagosR6 
...
save temp.dta, replace
	...
	use temp.dta, clear
		collapse (mean) mcp $indicatorlistall [pw=FQweight], by(xsurvey round year cmc `cov')	
			foreach var of varlist mcp $indicatorlistall {
				replace `var'=round(`var'*100, 1)
				}					
			gen group="By `cov'"	
	...
	use temp.dta, clear
		collapse (mean) mcp [pw=FQweight], by(xsurvey round year cmc `indicator')	
