...
```{r plotlevelSDPtypeUGfig2, fig.align="left", out.width="700px", out.height="200px"}
############### SDP
...
figSDP<-dtafig%>%
    plot_ly(x=~year, y=~essential5_offer, type = 'bar', 
                ...
                text = ~essential5_offer, textfont = list(size = 10) , textposition = 'outside') %>%
    add_trace(x=~year, y=~essential5_curav, 
                name = "available currently",
                marker = list(color = '#fdae6b'),
                text = ~essential5_curav, textfont = list(size = 10) , textposition = 'outside') %>%
    add_trace(y = ~essential5_noso, 
                name = "available currently/3-month",
                marker = list(color = '#fd8d3c'),
                text = ~essential5_noso, textfont = list(size = 10) , textposition = 'outside') %>% 
    add_trace(y = ~essential5_ready, 
                name = "Currently ready** to provide 5 specific methods*", 
                ...
                text = ~essential5_ready, textfont = list(size = 10) , textposition = 'outside') %>% 
    add_trace(y = ~essential5_rnoso, 
                name = "Meeting all conditions", 
                marker = list(color = '#d94801'),
                text = ~essential5_rnoso, textfont = list(size = 10) , textposition = 'outside') %>%     
    add_annotations(
        text = "Percent of SDPs with the methods",
    ...
    layout(
        yaxis = list(title = "",
                             font=list(size=8), range = c(0, 50), tickfont = list(size=8)),
        xaxis = list(title = "Survey year", font=list(size=8),tickfont = list(size=8)),
        showlegend = FALSE
        )
...
figIR<-dtafig%>%
    ...
    add_trace(y = ~SDPlow_essential5_rnoso, 
                      ...
                      text = ~SDPlow_essential5_rnoso, textfont = list(size = 10) , textposition = 'outside') %>%     
    add_annotations(
        text = "Percent of women served by",
        x = 0.5, y = 1, xref = "paper", yref = "paper",    
        xanchor = "center", yanchor = "bottom", showarrow = FALSE,
        font = list(size = 12)
        ) %>%
    add_annotations(
        text = "SDPs with the methods",
        x = 0.5, y = 0.90, xref = "paper", yref = "paper",    
        xanchor = "center", yanchor = "bottom", showarrow = FALSE,
        font = list(size = 12)
        ) %>%
...
subplot(figSDP, figIR, nrows=1, margin = 0.05, titleY = TRUE) %>%
    layout(yaxis = list(range = c(0, 50), font=list(size=8),
                        tickfont = list(size=8)) )
```

__India, Rajasthan__
```{r plotlevelSDPtypeIN, results='asis', fig.align="left", out.width="900px", out.height="200px"}
############### SDP
panel <- . %>% 
    plot_ly(x=~year, y=~essential5_offer, type = 'bar', 
                name = "Offer 5 specific methods*",
...
```{r plottrendSDPtypeUGfig3, fig.align="left", out.width="700px", out.height="200px"}
############### SDP
...
figIR<-dtafig%>%
    ...
    add_trace(y = ~SDPlow_essential5_rnoso, name = "Meeting both conditions", 
              ...
              line = list(color = '#084594')) %>% 
    add_annotations(
        text = "Percent of all women served by",
        x = 0.5, y = 1, xref = "paper", yref = "paper",    
        xanchor = "center", yanchor = "bottom", showarrow = FALSE,
        font = list(size = 12)
        ) %>%
...
subplot(figSDP, figIR, nrows=1, margin = 0.05, shareX = TRUE) %>%
    layout( 
            xaxis = list(title="Survey year", font=list(size=8)),
            yaxis = list(range = c(0, 50), 
                         font=list(size=8), tickfont = list(size=8))
            )

```

__India, Rajasthan__
```{r plottrendSDPtypeIN, results='asis', fig.align="left", out.width="900px", out.height="200px"}
############### SDP
panel <- . %>%
    plot_ly(x=~round, y=~essential5_offer, type = 'scatter', mode = 'lines',
            name = "offer 5 specific methods*",
...
dtafig<-dtaIR%>%filter(groupdemand==0)%>%
    filter(group=="All")%>%
    filter(is.na(SDPall_essential5_noso)==FALSE)%>%filter(country=="India, Rajasthan")
...
dtafig<-dtaIR%>%filter(groupdemand==0)%>%
    filter(group=="All")%>%
    filter(is.na(SDPlow_essential5_noso)==FALSE)%>%filter(country=="India, Rajasthan")
