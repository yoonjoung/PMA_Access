...
global datalist "BFR5 ETR6 INRajasthanR4 UGR6"

global datalistminusone "ETR6 INRajasthanR4 UGR6"
...
foreach survey  in BFR6{
	use "$data/HR_`survey'.dta", clear
		...
		sort EA_ID
		keep xsurvey EA_ID FQmetainstanceID  
...
*foreach survey  in BFR6{
	...
	* SDP characteristics 
	...
	gen byte SDPpub12	= country=="BF" & managing_authority==1 & (facility_type>=4) /*public, excludnig hospitals*/
	gen byte SDPlow		= country=="BF" & (facility_type>=4) /*excludnig hospitals*/
